        ...
        >
          ...
          >
            <SmotionDiv variants={descriptionVariants}>
              I&apos;m a undergraduate Student of Institut Teknologi Sumatera.
            </SmotionDiv>
            <SmotionDiv variants={descriptionVariants}>
        ...
        <div className="flex flex-col">
          ...
          <div className="text-5xl flex flex-wrap justify-center gap-9 xxsm:gap-12 sm:gap-16 lg:gap-20 py-3 text-teal-600">
            ...
            <SmotionLink
              ...
              whileHover={{ y: -0.5 }}
              transition={{ duration: 0.6, delay: 1.1 }}
              href={QUIET_NODE_INSTAGRAM_LINK}
              target="_blank"
              className="cursor-pointer hover:text-black"
              title="Instagram"
            >
              <AiFillInstagram color="#9356A0"  />
            </SmotionLink>
